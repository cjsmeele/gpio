...
namespace Kvasir {
	...
	namespace Register {
		...
		constexpr Gpio::Detail::MakeActionIfPinLocationT<TAction, T>
			action(TAction, T) {
			return{};
		}

		template<typename T>
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Input, T>
			makeInput(T) {
			return{};
		}
		...
		template<typename T>
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Output, T>
			makeOutput(T) {
			return{};
		}
		...
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Set, TPortPin>
			set(TPortPin) {
			return{};
		}
		...
		template<typename TPortPin>
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Clear, TPortPin>
			clear(TPortPin) {
			return{};
		}
		...
		template<typename TPortPin>
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Toggle, TPortPin>
			toggle(TPortPin) {
			return{};
		}

		template<typename TPP1, typename TPP2, typename... TPortPins>
		constexpr brigand::list<Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Toggle, TPP1>,
			Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Toggle, TPP2>,
			Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Toggle, TPortPins>...>
			toggle(TPP1, TPP2, TPortPins...) {
			return{};
		}

		template<typename TPortPin>
		constexpr Gpio::Detail::MakeActionIfPinLocationT<Gpio::Action::Read, TPortPin>
			read(TPortPin) {
			return{};
		}
